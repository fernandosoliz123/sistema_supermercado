...
if($nick !=""){
      ...
      foreach ($rs as $r => $fila) {
            ...
            if ($grup != $fila["grupo"]) {
                  ...
                  echo"<a onclick='location.href=\"#\"' style='cursor:pointer;'>".
                  $fila["grupo"]."</a>";    
                  $grup= $fila["grupo"];
            }
      echo "<ul>";
      ...
      if ($cuerp == false) {  echo"<a onclick='location.href=\"../claves/\"'><input type='button'name ='action' value='Cerrar Sesion' style='cursor:pointer,border-radius:10px;font-weight:bold;height:25px;'class='boton_cerrar'></a>";
      }else{
