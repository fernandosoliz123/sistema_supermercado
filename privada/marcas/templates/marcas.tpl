			...
			<tr>
				...
				<td align="center">
					<form name="formElimi{$r.id_marca}" method="post" action="marca_eliminar.php">
						<input type="hidden" name="id_marca" value="{$r.id_marca}">
						<a href="javascript:document.formElimi{$r.id_marca}.submit();" title="Eliminar Marca" onclick='javascript:return(confirm("Desea realmente Eliminar a  la Marca:::{$r.marca}?"));'>
							Eliminar>>
						</a>
					</form>
				</td>
