...
<body>
	...
	<center>
		<table class="listado">
			<tr>
				<th>NRO</th><th>NOMBRE</th><th>apellido_paterno</th><th>apellido_materno</th><th>cedula_de_identidad </th>
			...
			<tr>
				...
				<td align="center">
					<form name="formElimi{$r.id_cliente}" method="post" action="cliente_eliminar.php">
						<input type="hidden" name="id_cliente" value="{$r.id_cliente}">
						<a href="javascript:document.formElimi{$r.id_cliente}.submit();" title="Eliminar Cliente Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar a el cliente {$r.Nombre} {$r.apellido_paterno} {$r.apellido_materno} {$r.ci} {$r.direccion}  ')); location.href='cliente_eliminar.php'">
							Eliminar>>
						</a>
					</form>
				</td>
